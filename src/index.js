...
(function () {
  ...
  function injectStyle() {
    ...
    var text = [
      ...
      'body.' + BODY_CLASS + ' .card.focus, body.' + BODY_CLASS + ' .card.hover, body.' + BODY_CLASS + ' .card.traverse { transform: scale(1.07) translateY(-6px) rotateX(var(--rx, 0deg)) rotateY(var(--ry, 0deg)) !important; box-shadow: 0 20px 60px rgba(0,0,0,.55), 0 8px 20px rgba(0,0,0,.35) !important; z-index: 10 !important; position: relative !important; }',

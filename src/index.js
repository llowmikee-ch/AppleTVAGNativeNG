...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      'body.' + BODY_CLASS + ' .mapping--grid { display:grid !important; grid-template-columns:repeat(5, minmax(0, 1fr)) !important; gap: 1em .52em !important; align-items:start !important; }',

  ...
  (function () {
    ...
    function injectStyle() {
      ...
      var text = [
        ...
        'body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-shell__inner, body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-rightdock, body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-clock, body.' + BODY_CLASS + '.agnative-has-hero .head__menu-icon { background:transparent !important; box-shadow:none !important; backdrop-filter:none !important; -webkit-backdrop-filter:none !important; border-color:transparent !important; }',
        'body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-shell__item.is-active, body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-shell__item.hover, body.' + BODY_CLASS + '.agnative-has-hero .agnative-topnav-shell__item.focus { background:rgba(255,255,255,.18) !important; }',
        ...
        'body.' + BODY_CLASS + ' .agnative-hero__gradient { position:absolute; inset:0; border-radius:0; background:linear-gradient(0deg, var(--body-bg, #0a0a0f) 0%, rgba(0,0,0,.55) 14%, rgba(0,0,0,.20) 38%, transparent 65%), radial-gradient(ellipse 70% 60% at 0% 100%, rgba(0,0,0,.75) 0%, rgba(0,0,0,.35) 35%, transparent 70%); pointer-events:none; }',
        ...
        'body.' + BODY_CLASS + ' .agnative-hero__meta { font-size:.86em; color:rgba(255,255,255,.82); margin:0 0 .8em; text-shadow:0 1px 8px rgba(0,0,0,.5); }',
        'body.' + BODY_CLASS + ' .agnative-hero__overview { font-size:.92em; line-height:1.45; color:rgba(255,255,255,.92); margin:0 0 1.4em; text-shadow:0 1px 8px rgba(0,0,0,.6); display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical; overflow:hidden; max-width:100%; }',
        'body.' + BODY_CLASS + ' .agnative-hero__play.selector { display:inline-flex; align-items:center; justify-content:center; padding:.85em 2.4em; border-radius:999px; background:rgba(255,255,255,.94); border:0; color:#0a0a0f; font-size:1em; font-weight:700; cursor:pointer; outline:none; transition:background .2s ease, transform .2s ease, box-shadow .2s ease; }',
